//---------Author---------------//
//------Orbit Rover-------------//
//---This JavaScript(dependent on Jquery) File is Applicable for all table inside the no-more-tables Id attribute in any div---//
//----Just Use <script src="~/js/responsivetablejavascript.js"></script> bottom of the Jquery and Bootstrap js----//
//----This Js is applicable for all type of web applications where jquery.min.js is used like HTML, Angule, Recat, MVC, WebForms etc..----//
